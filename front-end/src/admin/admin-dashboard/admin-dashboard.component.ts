...
import { ProductAttributesService } from '../../app/products_attributes.service';
  ...
  saveCategory(): void {
    if (this.categoryDialog.category) {
      if (this.categoryDialog.category.id) {
        this.ProductAttributesService.updateCategory(this.categoryDialog.category.id, this.categoryDialog.category).subscribe({
          next: () => {
            this.loadCategories();
            this.hideDialog();
          },
        ...
        this.ProductAttributesService.createCategory(this.categoryDialog.category).subscribe({
          next: () => {
            this.loadCategories();
            this.hideDialog();
          },
